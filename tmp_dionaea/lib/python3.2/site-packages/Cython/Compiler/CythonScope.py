...
#        self.test_cythonscope()
    ...
    def test_cythonscope(self):
        ...
        # The view sub-scope
        #
        self.viewscope = viewscope = ModuleScope('cython.view', self, None)
...
cython_testscope_utility_code = CythonUtilityCode("""
...
test_cython_utility_dep = CythonUtilityCode("""
...
cythonview_testscope_utility_code = CythonUtilityCode("""
