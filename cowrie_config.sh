...
sed -i 's/listen_endpoints = tcp:2222:interface=0.0.0.0/listen_endpoints = tcp:22:interface='$raspi_pubip'/g' /home/cowrie/cowrie/etc/cowrie.cfg
sed -i 's/enabled = false/enabled = true/g' /home/cowrie/cowrie/etc/cowrie.cfg
sed -i 's/listen_endpoints = tcp:2223:interface=0.0.0.0/listen_endpoints = tcp:23:interface='$raspi_pubip'/g' /home/cowrie/cowrie/etc/cowrie.cfg
